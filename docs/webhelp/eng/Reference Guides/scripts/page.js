...
Page.OnLoad = function (param_event_or_redirect_url) {
  ...
  if (Page.window === Page.window.top && Page.window.navigator.userAgent.indexOf('bot/') === -1) {
    ...
    if (dropdown_toggle_button !== null) {
      var dropdown_ids_string, dropdown_ids;

      dropdown_ids_string = document.getElementById('dropdown_ids').innerText;
