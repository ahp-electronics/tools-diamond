/* Verilog netlist generated by SCUBA Diamond_1.2_Beta (70) */
/* Module Version: 3.5 */
/* C:\lscc\diamond\1.2\ispfpga\bin\nt\scuba.exe -w -lang verilog -synth synplify -bus_exp 7 -bb -arch xo2c00 -type sspram -addr_width 5 -num_rows 32 -data_width 8 -outData UNREGISTERED -e  */
...
module RAM_single_port (Address, Data, Clock, WE, ClockEn, Q);
    ...
    SPR16X4C mem_0_0 (.DI0(Data[4]), .DI1(Data[5]), .DI2(Data[6]), .DI3(Data[7]), 
        ...
        .DO2(mdL0_0_6), .DO3(mdL0_0_7))
             ...
             /* synthesis MEM_LPC_FILE="RAM_single_port.lpc" */
