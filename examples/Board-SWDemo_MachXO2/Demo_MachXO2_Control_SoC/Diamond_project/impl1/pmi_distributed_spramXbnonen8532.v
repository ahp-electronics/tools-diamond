...
/* Module Version: 3.5 */
/* C:/lscc/1.3_20110802-1_3p.92/diamond/1.3/ispfpga/bin/nt/scuba -w -bus_exp 7 -bb -arch xo2c00 -type sspram -num_rows 32 -data_width 8 -memformat bin -n pmi_distributed_spramXbnonen8532 -pmi -lang verilog  */
/* Fri Oct 14 15:11:28 2011 */


`timescale 1 ns / 1 ps
module pmi_distributed_spramXbnonen8532 (Address, Data, Clock, WE, 
    ClockEn, Reset, Q);
    ...
    SPR16X4C mem_0_0 (.DI0(Data[4]), .DI1(Data[5]), .DI2(Data[6]), .DI3(Data[7]), 
        ...
        .DO2(mdL0_0_6), .DO3(mdL0_0_7))
             ...
             /* synthesis MEM_LPC_FILE="pmi_distributed_spramXbnonen8532__PMI__32__8__8B" */
    ...
    // exemplar attribute mem_0_0 MEM_LPC_FILE pmi_distributed_spramXbnonen8532__PMI__32__8__8B
    // exemplar attribute mem_0_0 COMP mem_0_0
    // exemplar attribute mem_0_1 MEM_INIT_FILE (0-15)(4-7)
    // exemplar attribute mem_0_1 MEM_LPC_FILE pmi_distributed_spramXbnonen8532__PMI__32__8__8B
    // exemplar attribute mem_0_1 COMP mem_0_1
    // exemplar attribute mem_1_0 MEM_INIT_FILE (16-31)(0-3)
    // exemplar attribute mem_1_0 MEM_LPC_FILE pmi_distributed_spramXbnonen8532__PMI__32__8__8B
    // exemplar attribute mem_1_0 COMP mem_1_0
    // exemplar attribute mem_1_1 MEM_INIT_FILE (16-31)(4-7)
    // exemplar attribute mem_1_1 MEM_LPC_FILE pmi_distributed_spramXbnonen8532__PMI__32__8__8B
