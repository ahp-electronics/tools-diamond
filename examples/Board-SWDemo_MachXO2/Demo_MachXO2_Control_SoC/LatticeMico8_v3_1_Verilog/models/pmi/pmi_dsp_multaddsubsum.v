...
/*
--------------------------------------------------------------------------------
DataAwidth         <integer>                                          8
DataBwidth         <integer>                                          8
module_type         <string>                                          "pmi_dsp_multaddsubsum"
additional_pipeline         <integer>                                          1
input_reg         <integer>                                          8
output_reg         <integer>                                          8
pmi_family         <"ECP"|"ECP2">                                          "ECP"
...
reg [(pmi_dataa_width + pmi_datab_width + 1):0] sum_o;
...
reg [(pmi_dataa_width + pmi_datab_width + 1):0] sumt_reg;
