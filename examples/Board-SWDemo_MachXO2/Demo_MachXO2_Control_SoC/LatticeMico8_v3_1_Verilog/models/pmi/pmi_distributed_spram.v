...
*/
// $Header: /home/dmsys/pvcs/RCSMigTest/rcs/verilog/pkg/versclibs/data/pmi/RCS/pmi_distributed_spram.v,v 1.6 2005/08/15 13:06:09 rag Exp $
...
initial begin
   if (clogb2(pmi_addr_depth-1) > pmi_addr_width) begin
	...
	//Non-SC/SCM/XP2 families don't support init files
	if ( (pmi_family != "SC") && (pmi_family != "SCM") && (pmi_family != "XP2") &&
		  (pmi_init_file != "none") )
	begin
...
initial begin
   if (pmi_init_file == "none")
	begin
		...
		else //Initialize non-SC/SCM/XP2 memories to X's
			for (h = 0; h < 2**pmi_addr_width; h = h+1)
