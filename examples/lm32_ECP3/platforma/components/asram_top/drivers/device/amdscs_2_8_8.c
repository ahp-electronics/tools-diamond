...
**     SPANSION CFI FLASH in a 2 x 8-bit configuration
**
**  $Revision: $
**
** Disclaimer:
 ...
 ****************************/
   ...
   FlashConfiguration_st AmdSCS_2_8_8;
   static FlashBoardCfgInfo_t AmdSCS_2_8_8Info;
   static FlashCfgFnTbl_t AmdSCS_2_8_8FnTbl;

#define PUI_2_PUS(input) ((*(unsigned short*)(&(input))))
 ...
 ****************************/
   ...
   static void         AmdSCS_2_8_8_Init(CFIFlashDevCtx_t *ctx);
   static unsigned int AmdSCS_2_8_8_Reset(CFIFlashDevCtx_t *ctx);
   static unsigned int AmdSCS_2_8_8_ProgramData(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset, unsigned char *Data, unsigned int Bytes);
   static unsigned int AmdSCS_2_8_8_SectorInfo(CFIFlashDevCtx_t *, unsigned int ByteOffset, unsigned int *SAddr, unsigned int *ByteLen);
   static unsigned int AmdSCS_2_8_8_EraseRegion(CFIFlashDevCtx_t *ctx);
   static unsigned int AmdSCS_2_8_8_EraseSector(CFIFlashDevCtx_t *ctx, unsigned int Offset);
   static unsigned int AmdSCS_2_8_8_Write16(CFIFlashDevCtx_t *ctx, unsigned int Offset, unsigned short usData);
   static unsigned int AmdSCS_2_8_8_WriteData(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset, unsigned char *data, unsigned int Bytes);
...
unsigned int Register_AmdSCS_2_8_8_Configuration(void) {
    ...
    *----------------------------------------------
    */
   AmdSCS_2_8_8Info.parallels = 2;
   AmdSCS_2_8_8Info.mode = 8;
    ...
    *----------------------------------------------
    */
   AmdSCS_2_8_8FnTbl.Init          = AmdSCS_2_8_8_Init;
   AmdSCS_2_8_8FnTbl.WriteData     = AmdSCS_2_8_8_WriteData;
   AmdSCS_2_8_8FnTbl.WriteData8    = 0;
   AmdSCS_2_8_8FnTbl.WriteData16   = AmdSCS_2_8_8_Write16;
   AmdSCS_2_8_8FnTbl.WriteData32   = 0;
   AmdSCS_2_8_8FnTbl.EraseChip     = AmdSCS_2_8_8_EraseRegion;
   AmdSCS_2_8_8FnTbl.EraseSector   = AmdSCS_2_8_8_EraseSector;
   AmdSCS_2_8_8FnTbl.Reset         = AmdSCS_2_8_8_Reset;
   AmdSCS_2_8_8FnTbl.ProgramData   = AmdSCS_2_8_8_ProgramData;
   AmdSCS_2_8_8FnTbl.SectorInfo    = AmdSCS_2_8_8_SectorInfo;
    ...
    *----------------------------------------------
    */
   AmdSCS_2_8_8.VendorCSId =  0x2;       /* AMD/Fujitsu Standard Command Set */
   AmdSCS_2_8_8.boardInfo  =  &AmdSCS_2_8_8Info;
   AmdSCS_2_8_8.cfgFnTbl   =  &AmdSCS_2_8_8FnTbl;
...
static unsigned int AmdSCS_2_8_8_Reset(CFIFlashDevCtx_t *ctx) {
   ...
   PUI_2_PUS(pt_CFIFlashDev->base) = CFI_2_8_FF;
   return(0);
}
 ...
 */
static unsigned int
AmdSCS_2_8_8_EraseRegion(CFIFlashDevCtx_t *ctx) {
   ...
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_AA;
   PUI_2_PUS(pDWA_FlashDev->Addr2AA) = CFI_2_8_55;
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_80;
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_AA;
   PUI_2_PUS(pDWA_FlashDev->Addr2AA) = CFI_2_8_55;
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_10;
   ...
   do{
      ...
      if(pDWA_FlashDev->base == CFI_2_8_ERASED)
         return(0);
 ...
 */
static unsigned int
AmdSCS_2_8_8_EraseSector(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset) {

   unsigned int maxTOMilliSecs;
   pt_DWORD_ALIGNED_CFI_FLASH pDWA_FlashDev = (pt_DWORD_ALIGNED_CFI_FLASH)ctx->base;
   //unsigned short *cmdPtr = (unsigned short *)(ctx->base);
   unsigned short *writePtr = (unsigned short *)(ctx->base + (ByteOffset*2));
   ...
   *(unsigned short*)(writePtr) = CFI_2_8_30;
 ...
 */
static unsigned int
AmdSCS_2_8_8_WriteData(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset, 
   ...
   for(loopVar = ByteOffset; loopVar < endOffset; loopVar+=sizeof(short)) {
      if(AmdSCS_2_8_8_Write16(ctx, loopVar, *pusData)!= 0)
 ...
 */
static unsigned int
AmdSCS_2_8_8_Write16(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset, 
   ...
   /*
    * write program-sequence, command activation is on DWORD boundaries
    */
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_AA;
   PUI_2_PUS(pDWA_FlashDev->Addr2AA) = CFI_2_8_55;
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_A0;
...
static unsigned int 
AmdSCS_2_8_8_ProgramData(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset, 
                           unsigned char *Data, unsigned int Bytes) {
   ...
   sAddr = ByteOffset;
   do{
      retVal = AmdSCS_2_8_8_SectorInfo(ctx, sAddr, &sAddr, &byteLen);
      if(retVal != 0)
         return(retVal);
      AmdSCS_2_8_8_EraseSector(ctx, sAddr);
      sAddr += byteLen;
   ...
   retVal = AmdSCS_2_8_8_WriteData(ctx, ByteOffset, Data, Bytes);
...
/* Fetch Sector Info */
static unsigned int 
AmdSCS_2_8_8_SectorInfo(CFIFlashDevCtx_t *ctx, unsigned int ByteOffset, 
...
static void AmdSCS_2_8_8_Init(CFIFlashDevCtx_t *ctx) {
   ...
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_AA;
   PUI_2_PUS(pDWA_FlashDev->Addr2AA) = CFI_2_8_55;
   PUI_2_PUS(pDWA_FlashDev->Addr555) = CFI_2_8_90;
   /* flush data-cache */
   MicoFlushDataCache();
    ...
    */
   if(PUI_2_PUS(pDWA_FlashDev->base) == CFI_2_8_MXID) {
      /* IF IT's A MX29LV128M DEVICE, USE PRE-DETERMINED DATA */
      if(PUI_2_PUS(pDWA_FlashDev->base1) == CFI_2_8_MXDEV) {
