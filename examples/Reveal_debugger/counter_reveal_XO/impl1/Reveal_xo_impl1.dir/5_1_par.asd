...
GLOBAL_SECONDARY_1_SIGNALNAME = counter_top_reveal_coretop_instance/counter_top_la0_inst_0/reset_rvl_n;
GLOBAL_SECONDARY_1_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_1_LOADNUM = 91;
GLOBAL_SECONDARY_1_SIGTYPE = RST;
; Global secondary clock #2
GLOBAL_SECONDARY_2_SIGNALNAME = mj5ghub/jrstn_int;
GLOBAL_SECONDARY_2_DRIVERTYPE = JTAG;
GLOBAL_SECONDARY_2_LOADNUM = 132;
