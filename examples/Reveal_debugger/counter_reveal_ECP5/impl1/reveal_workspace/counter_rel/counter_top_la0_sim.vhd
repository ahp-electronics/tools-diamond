-- =============================================================================
--  VHDL simulation model generated by IPExpress    05/02/2017    15:30:05         
--  Filename: counter_top_la0_sim.vhd                                          
...
entity counter_top_la0 is
    PORT (
        ...
        trigger_din_0:	IN std_logic_vector (5 downto 0);
        trace_din:	IN std_logic_vector (5 downto 0);
...
architecture counter_top_la0_u of counter_top_la0 is
begin

    er2_tdo <= '0';

end counter_top_la0_u;
