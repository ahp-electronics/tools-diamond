...
counter_top_la0_inst: counter_top_la0
   port map (
       clk		=> clk,
       reset_n		=> reset_n,
       jtck		=> jtck,
       ...
       jshift		=> jshift,
       jupdate		=> jupdate,
       trigger_din_0	=> trigger_din_0(5 downto 0),
       trace_din	=> trace_din(5 downto 0),
       ip_enable        => ip_enable
)

object /* synthesis GSR=DISABLED */
object /* synthesis UGROUP=”counter_top_la0_core” */
pragma // attribute UGROUP ”counter_top_la0_core” 
;
