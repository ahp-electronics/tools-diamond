//============================================================================
// @(#) $Id: sv2sc2sv_xl_gp_converter_loopback_dual_ports.cpp 1777 2018-01-06 04:54:00Z jstickle $
//============================================================================
...
class top : public sc_module {
  ...
  public:
    ...
    top( sc_module_name nm ) : sc_module( nm ), loop( "loop" ) {
        uvmc_connect<uvmc_xl_converter<tlm_generic_payload> >(loop.in,"42");
        uvmc_connect<uvmc_xl_converter<tlm_generic_payload> >(
            loop.in_config, "out_config" );

        uvmc_connect<uvmc_xl_converter<tlm_generic_payload> >(
            loop.out_write, "43write" );
        uvmc_connect<uvmc_xl_converter<tlm_generic_payload> >(
            loop.out_read, "43read" );
        uvmc_connect<uvmc_xl_converter<tlm_generic_payload> >(
