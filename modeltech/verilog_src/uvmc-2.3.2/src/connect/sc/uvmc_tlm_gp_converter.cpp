//============================================================================
// @(#) $Id: uvmc_tlm_gp_converter.cpp 1875 2019-11-04 21:44:45Z jstickle $
//============================================================================
...
static set<unsigned char *> duplicated_storage_set;
#endif
    ...
    svBitVecVal *dst_sv_array_chandle )
{
    ...
    duplicated_storage_set.insert(duplicated_storage);
    ...
    unsigned long long c_array_chandle )
{
    ...
    if( c_array_chandle != 0 ){
        ...
        set<unsigned char *, bool>::iterator it =
            duplicated_storage_set.find( duplicated_storage );

        if( it != duplicated_storage_set.end() ){
            duplicated_storage_set.erase(it);
