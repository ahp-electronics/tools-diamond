//============================================================================
// @(#) $Id: uvmc_xl_config.h 1791 2018-04-05 00:25:21Z jstickle $
//============================================================================
...
class uvmc_xl_config_base : public tlm_extension<uvmc_xl_config_base> {
  private:
    ...
    bool m_is_static_config_deletion_enabled;
    bool m_is_sideband_config_deletion_enabled;
  ...
  public:
    ...
    ~uvmc_xl_config_base(){
        if( m_is_static_config_deletion_enabled == true )
            delete [] m_static_config;
        if( m_is_sideband_config_deletion_enabled == true )
            delete [] m_sideband_config;
    }
    ...
    void set_raw_static_config( const unsigned char *staticConfig ) {
        if( m_is_static_config_deletion_enabled == true ) {
            delete [] m_static_config;
            m_is_static_config_deletion_enabled = false;
        }
        m_static_config
    ...
    void set_raw_sideband_config( const unsigned char *sidebandConfig ) {   
        if( m_is_sideband_config_deletion_enabled == true ) {
            delete [] m_sideband_config;
            m_is_sideband_config_deletion_enabled = false;
        }
        m_sideband_config
            = const_cast<svBitVecVal *>(
