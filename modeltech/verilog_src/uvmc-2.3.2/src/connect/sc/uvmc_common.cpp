...
void uvmc_proxy_base::blocking_rsp_done(const bits_t *bits, sc_dt::uint64 delay) {
...
void uvmc_proxy_base::x_b_transport (bits_t *bits, sc_dt::uint64 delay ) {
  UVMCERR(x_b_transport);
}

int uvmc_proxy_base::x_nb_transport_fw (bits_t *bits, uint32 *phase, sc_dt::uint64 *delay ) {
  UVMCERR(x_nb_transport_fw);
  return tlm::TLM_COMPLETED;
}

int uvmc_proxy_base::x_nb_transport_bw (bits_t *bits, uint32 *phase, sc_dt::uint64 *delay ) {
...
int SV2C_nb_transport_fw (int id, bits_t *bits, uint32 *phase, sc_dt::uint64 *delay) {
  GET_PROXY_FROM_ID(SV2C_nb_transport_fw,tlm::TLM_COMPLETED)
  return proxy->x_nb_transport_fw(bits,phase,delay);
}

int SV2C_nb_transport_bw (int id, bits_t *bits, uint32 *phase, sc_dt::uint64 *delay) {
  GET_PROXY_FROM_ID(SV2C_nb_transport_bw,tlm::TLM_COMPLETED)
  return proxy->x_nb_transport_bw(bits,phase,delay);
}

bool  SV2C_b_transport (int id, bits_t* bits, sc_dt::uint64 delay) {
