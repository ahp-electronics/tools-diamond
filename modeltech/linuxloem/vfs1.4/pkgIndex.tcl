...
namespace eval ::vfs {}
variable ::vfs::dll [file join $dir libvfs1.4.so]
...
proc ::vfs::loadvfs {libdir dll} {
    ...
    # Make sure this is a real library and not
    # an archive (staticlly bound)
    if {[file extension $dll] eq [info sharedlibextension]} {
...
package ifneeded vfs 1.4 [list ::vfs::loadvfs $dir $vfs::dll]
