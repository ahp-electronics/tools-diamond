...
#
#	MODIFIED BY MGC TO ADD Button LABEL OPTION
#		- option is -titleopen, -titlesave
...
proc ::tk::dialog::file::Config {dataName type argList} {
    ...
    # Configure customized modes and button text
...
proc ::tk::dialog::file::ResolveFile {context text defaultext {expandEnv 1}} {
    ...
    if {
	![file isdirectory $path] && ([file extension $path] eq "") &&
