 ...
 *
 * The functionality described in this header file is defined in Accellera SystemVerilog SV3.1a.
...
svBitVecVal*   svGetBitVecValFromBitPackedArrRef(svBitPackedArrRef s);
  ...
  *
  * Open array access interfaces for vector bitvector elements:
  *
...
void svPutBitArrElemVec32 (const svOpenArrayHandle d, const svBitVec32* s, int indx1, ...); 
