...
extern void*
mti_svGetCurrVerilogProcHandle(void);
...
extern void
mti_svHandleDPIDisable(int isDisabled);
...
extern int
mti_IsInOutOfTheBlueCall(void);

extern void
mti_svGetNearestImportInfo(
    void* nearestImport);
...
extern void
vl_dpi_init_thread_states(const void *data, int is_import_call);
