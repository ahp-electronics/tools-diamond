...
/* nocheck variant functions */
extern vpiHandle vqpi_handle_by_name_nocheck(PLI_BYTE8 *name, vpiHandle scope);
extern vpiHandle vqpi_handle_nocheck(PLI_INT32 type, vpiHandle referenceHandle);
extern vpiHandle vqpi_iterate_nocheck(PLI_INT32 type, vpiHandle referenceHandle);
extern void vqpi_get_value_nocheck(vpiHandle object, p_vpi_value value_p);
extern vpiHandle vqpi_put_value_nocheck(vpiHandle   object,
                                p_vpi_value value_p,
                                p_vpi_time  time_p,
                                PLI_INT32   flags);
extern vpiHandle vqpi_register_cb_nocheck(p_cb_data cb_data_p);

extern void *vqpi_to_mti(vpiHandle vpi_object);
extern vpiHandle mti_to_vqpi(void *sim_object);
extern void *vqpi_to_mti_qwavedb(vpiHandle vpi_object);
extern int vqpi_is_unbound_vhdl_inst(vpiHandle vpi_object);
extern vpiHandle vqpi_register_assertion_cb(vpiHandle assertion, PLI_INT32 reason, vpi_assertion_callback_func *cb_rtn, PLI_BYTE8 *user_data);
