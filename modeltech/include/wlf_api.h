...
/* $Id: //dvt/mti/rel/2020.3_oct_lattice/src/tkgui/wlf_api.h#1 $ */
...
typedef enum WlfPropEnum_ {
    ...
    WLF_PROP_SYMBOL_STREAM_KIND         /* return: char *               */
} WlfPropEnum;
...
typedef enum WlfTypePropEnum_ {
    ...
    WLF_TYPE_CONTAINS_MEMELEM           /* return: int                    */
} WlfTypePropEnum;
...
typedef WlfUInt64    WlfSymbolSel64;
...
#define wlfSelSubprogram        0x4000000000000000LL
...
#define wlfSelSubprogram        0x4000000000000000
#endif
...
#define wlfTypeVlogWReal        46

#define wlfTypeByte				53
...
extern char         *wlfFileDiag       (WlfFileId fp);
extern int           wlfFileHeader     (char *filename, WlfFileInfo *buf);
extern int           wlfFileGetVersion (WlfFileId fp);
...
/* utility, compares two string values taking into consiration their TypeId */
extern int          wlfCompareByType     ( WlfTypeId type1, WlfTypeId type2, char *val1, char *val2);
...
typedef WlfCallbackResponse (*WlfMessageCB)(          /*Used in examine*/
                        ...
                        void               **value,
                        void                *cbData);
typedef WlfCallbackResponse (*WlfSearchEventCB)( 
                        void                *cbData, 
                        WlfValueId           valueId,
                        WlfTime64            newTime, 
                        int                  newDelta,
...
extern int wlfGetCallbackCount(
                        WlfPackId           packId );

extern void wlfSetAllowDuplicateCallbacks(
                        WlfPackId           packId,
                        int                 allow );
...
extern WlfTypeId    wlfWrtCreateWrealType( WlfWrtFileId fp, double left, double right);
...
extern int          wlfWrtGetChannelNumberCount( WlfSymbolId sym );
extern int          wlfWrtGetChannelNumber( WlfSymbolId sym, int index );
