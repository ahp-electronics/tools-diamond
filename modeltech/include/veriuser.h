...
/* $Id: //dvt/mti/rel/2020.3_oct_lattice/src/vsim/veriuser.h#1 $ */
...
/* object is defined imported by the dll */
#define XXTERN PLI_EXTERN PLI_DLLISPEC
/* object is defined exported by the dll */
...
#ifdef MTI_STRICT_PROTOTYPES
typedef PLI_INT32 (*p_tffn)(int data, int reason);
typedef PLI_INT32 (*p_tffnm)(int data, int reason, int paramvc);
#else
typedef PLI_INT32 (*p_tffn)();
typedef PLI_INT32 (*p_tffnm)();
#endif
...
typedef struct t_tfcell
{
	...
	p_tffnm   misctf;   /* miscellaneous reason callback function       */
...
#ifdef MTI_STRICT_PROTOTYPES
typedef char *(*p_tf_routinefn)(void);
#else
typedef char *(*p_tf_routinefn)();
#endif
...
XXTERN p_tf_routinefn   tf_getroutine PROTO_PARAMS((void));
...
XXTERN p_tf_routinefn   tf_igetroutine PROTO_PARAMS((void *inst));
...
XXTERN void             tf_isetroutine PROTO_PARAMS((p_tf_routinefn routine, void *inst));
...
XXTERN void             tf_setroutine PROTO_PARAMS((p_tf_routinefn routine));
...
#if defined(VERIUSER_DEFINED_DLLESPEC) && !defined(VERIUSERTFS_NOEXPORT)
