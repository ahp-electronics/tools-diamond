#$Header: L:/module/adder_substractor/gui/rcs/core_template.tcl 1.9 2008/02/04 06:13:56Z mghuang Exp $
...
proc Or5s00Cmd {}  {
	...
	switch $Para(CoreName) {
		...
		"Adder_Subtractor" { lappend str -arch $Para(arch) -type addsub }
