#$Header: L:/module/ram_dq/machxo2/gui/core_template.tcl 1.7 mghuang Exp $

#Rev 1.6/1.7: Diamond 3.1 IPExpress: Fixed SOF-118880
#Rev 1.5: Diamond 3.1 IPExpress: XO3 support
...
if {$Para(arch) == "se5c00" || $Para(arch) == "se5r00"} {
	...
	#--- Page #2 ---
		...
		Create3RadioItem $frmAdvanced PortAWM "" 20 \
			...
			"Read before Write" ReadBeforeWrite 15 top Para(Write) {}
