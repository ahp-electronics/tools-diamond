#$Header: L:/module/fifo_dc/sn5w00/gui/core_template.tcl 1.1 mghuang Exp $
...
proc ChangeValueCmd {} {
	...
	if {$Para(FIFOImp) == "LUT Based"} {
		...
		.cboAddress insert list end 2 4 8 16 32 64 128 256 512 1024 2048 4096
		.cboRAddress insert list end 2 4 8 16 32 64 128 256 512 1024 2048 4096
		if {$Para(Depth) > 4096} {set Para(Depth) 4096}
		if {$Para(RDepth) > 4096} {set Para(RDepth) 4096}
