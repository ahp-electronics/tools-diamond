#$Header: L:/module/sdr/latticeecp3/gui/rcs/core_template.tcl 1.7 2009/09/07 08:39:50Z mghuang Exp $
#Rev 1.7 Fixed cr_48479
...
proc ChangeValueCmd {} {
	...
	if {$Para(mode) == "Receive"} {
		...
		set del_lst {Bypass Dynamic "User Defined" "Fixed Delay"}
		...
		#if {[lsearch $io_type_lst $Para(io_type)] ==-1} {set Para(io_type) RSDS}
...
proc ECP3CmdLine {}  {
	...
	if {$Para(mode) == "Receive"}  {
		...
		"Fixed Delay"	{ lappend str -del 32}
		}
	}
...
proc Create_Image {} {
	...
	#*** Here for user to add extra pages ***
		...
		set w [expr $w-3]
		CreateLabelCombobox $setframe del "Data Path Delay" $w 16 Para(del) {Bypass Dynamic "User Defined" "Fixed Delay"} {ChangeValueCmd}
