#$Header: L:/module/adder_tree/gui/rcs/core_template.tcl 1.2 2008/10/17 07:51:50Z mghuang Exp $
#!/bin/sh
...
proc CheckParameterCB {} {
	...
	set ret [IsInRange "Width" 2 54 $Para(width)]
	if {$ret == "-1"} {return -1}
	set ret [IsInRange "Number of Inputs" 2 33 $Para(num_input)]
	if {$ret == "-1"} {return -1}
...
proc GenerateCB {} {
	...
	#adder_tree -width <w> -num_input <n> -input_reg -output_reg -pipeline 1 <other scuba options>
	set str "-arch $Para(arch) -type adder_tree "
...
proc Create_Image {} {
	...
	CreateLabelEntryLabel $frmP1 width "Width" 4 "(2 - 54)" "" Para(width) integer
	
	CreateLabelEntryLabel $frmP1 num_input "Number of Inputs" 4 "(2 - 33)" "" Para(num_input) integer
