#$Header: L:/module/mac/latticeecp3/gui/core_template.tcl 1.12 mghuang Exp $

#Rev 1.12: Diamond 2.1 IPExpress: Fixed CR_52546 - Output register is always enabled for MAC/MMAC. to make it consistent to Application Handbook, UM not updated.
