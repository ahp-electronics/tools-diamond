...
# cfg\cae_library\pkg\simulation\script\pkg\cmpl_libs-pkg.tcl 1.6 24-APR-2013 15:10:18 IALMOHAN
#

package provide cmpl_libs 1.0
package require Tcl 8.5

proc Usage {} {
   puts {Usage: cmpl_libs -sim_path <sim_path> [-sim_vendor {mentor<default>}] [-lang {verilog|vhdl|all<default>}] [-device {sc|scm|ec|xp|ecp|machxo|ecp2|ecp2m|xp2|ecp3|machxo2|machxo3l|machxo3d|lptm|lptm2|ecp5u|ecp5um|lfmnx|lifmd|lifmdf|all<default>}] [-target_path <target_path>]}
#   exit -1
}
...
set all_devices "sc scm ec xp ecp machxo ecp2 xp2 ecp3 machxo2 machxo3d machxo3l lptm ecp5u lfmnx lptm2 lifmd lifmdf";
...
set env(PATH) "$sim_path;$env(PATH);$script_path/pkg"
...
source "$script_path/pkg/cmpl_vlg-pkg.tclproc"
...
source "$script_path/pkg/cmpl_vhd-pkg.tclproc"
